...
The Hamiltonian $H^M$ in the Schrödinger equation~(\ref{eq:CISchroedinger}) may be written as a sum of non-interacting Hamiltonian $\hat{H}_0^M$ and interacting term $\hat{V}^M$
%
\begin{equation}
